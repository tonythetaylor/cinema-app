...
class User(ORMBase):
    ...
    joined_parties = relationship("WatchPartyParticipant", back_populates="user")

    hosted_parties = relationship("WatchParty", back_populates="host", cascade="all, delete-orphan")
